...
AR_SUBFUND_SCHEMA = {
    ...
    "posiciones": "list[{nombre, peso_pct, sector, pais, tipo, emisor, rating, cupon, vencimiento}] TODOS los holdings del sub-fondo (de 'Securities Portfolio'/'Schedule of Investments'/'Portfolio of Investments'). LEE LA SECCIÓN COMPLETA: en un fondo de renta fija son 100-300+ líneas repartidas en 5-15 páginas — NO devuelvas solo el Top-Ten. Si un fondo de bonos te sale con <=15 posiciones, NO leíste la sección entera: vuelve y lee TODAS las páginas del portfolio. El Top-Ten va aparte en 'top_10', NUNCA es la cartera. tipo = clase de activo SEGÚN LA SECCIÓN del AR: 'RV' (Shares/Equities), 'RF' (Bonds/Notes/debt), 'fondo' (Investment/Open-ended funds), 'warrant' (Warrants and rights), 'future'/'option'/'swap'/'forward' (Derivatives), 'liquidez' (Cash). NO marcar 'otros' si es una acción. Para bonos (RF): emisor = nombre del emisor; rating = calificación crediticia SOLO si el AR muestra columna de rating (Moody's/S&P/Fitch, ej 'BBB', 'BB+', 'NR'), si no aparece → null; cupon = float del % si está en el nombre; vencimiento = fecha ISO si está.",
