...
```json
{
  ...
  "ter": <ter>,
  "comision_gestion_pct": <fees[name="Gestión"].pct de la clase que coincidió (matched_isin)>,
  "comision_exito_pct": <fees[name="Gestión por resultado"].pct si > 0, si no omitir>,
  "clase_retail_isin": "<matched_isin: es la clase accesible al particular en MyInvestor; su comisión es la de referencia (Rafa 2026-09-24)>",
  "srri": <risk_indicator>,
